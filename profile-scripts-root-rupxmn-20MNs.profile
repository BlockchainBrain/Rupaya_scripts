...
replicate1-17(){
	...
	cp -i /home/rupxmn17/.rupayacore/rupaya.conf ~/rupaya17.conf
	echo Deleting the .rupayacore directory
	rm -rf /home/rupxmn17/.rupayacore
	echo Copying over the MN1 directories
	cp -R /home/rupxmn/.rupayacore /home/rupxmn17/.rupayacore
	wait
	echo Restoring the rupaya.conf file && sleep 10
	cp -i rupaya17.conf /home/rupxmn17/.rupayacore/rupaya.conf
	chown rupxmn17:rupxmn17 -R /home/rupxmn17/.rupayacore
	chown rupxmn17:rupxmn17 -R /home/rupxmn17/.rupayacore/*
	...
	runuser -l rupxmn17 -c 'rupayad -daemon'
}
...
replicate1-18(){
	...
	cp -i /home/rupxmn18/.rupayacore/rupaya.conf ~/rupaya18.conf
	echo Deleting the .rupayacore directory
	rm -rf /home/rupxmn18/.rupayacore
	echo Copying over the MN1 directories
	cp -R /home/rupxmn/.rupayacore /home/rupxmn18/.rupayacore
	wait
	echo Restoring the rupaya.conf file && sleep 10
	cp -i rupaya18.conf /home/rupxmn18/.rupayacore/rupaya.conf
	chown rupxmn18:rupxmn18 -R /home/rupxmn18/.rupayacore
	chown rupxmn18:rupxmn18 -R /home/rupxmn18/.rupayacore/*
	...
	runuser -l rupxmn18 -c 'rupayad -daemon'
}
...
replicate1-19(){
	...
	cp -i /home/rupxmn19/.rupayacore/rupaya.conf ~/rupaya19.conf
	echo Deleting the .rupayacore directory
	rm -rf /home/rupxmn19/.rupayacore
	echo Copying over the MN1 directories
	cp -R /home/rupxmn/.rupayacore /home/rupxmn19/.rupayacore
	wait
	echo Restoring the rupaya.conf file && sleep 10
	cp -i rupaya19.conf /home/rupxmn19/.rupayacore/rupaya.conf
	chown rupxmn19:rupxmn19 -R /home/rupxmn19/.rupayacore
	chown rupxmn19:rupxmn19 -R /home/rupxmn19/.rupayacore/*
	...
	runuser -l rupxmn19 -c 'rupayad -daemon'
}
...
replicate1-20(){
	...
	cp -i /home/rupxmn20/.rupayacore/rupaya.conf ~/rupaya20.conf
	echo Deleting the .rupayacore directory
	rm -rf /home/rupxmn20/.rupayacore
	echo Copying over the MN1 directories
	cp -R /home/rupxmn/.rupayacore /home/rupxmn20/.rupayacore
	wait
	echo Restoring the rupaya.conf file && sleep 10
	cp -i rupaya20.conf /home/rupxmn20/.rupayacore/rupaya.conf
	chown rupxmn20:rupxmn20 -R /home/rupxmn20/.rupayacore
	chown rupxmn20:rupxmn20 -R /home/rupxmn20/.rupayacore/*
	...
	runuser -l rupxmn20 -c 'rupayad -daemon'
}
...
backup17(){
	echo Backing up the /home/rupxmn17/.rupayacore/rupaya.conf file to /root/rupaya17.conf
	cp /home/rupxmn17/.rupayacore/rupaya.conf ~/rupaya17.conf
	echo Backup complete
}
#
#MN18 - Backing up the rupaya.conf file
backup18(){
	echo Backing up the /home/rupxmn18/.rupayacore/rupaya.conf file to /root/rupaya18.conf
	cp /home/rupxmn18/.rupayacore/rupaya.conf ~/rupaya18.conf
	echo Backup complete
}
#
#MN19 - Backing up the rupaya.conf file
backup19(){
	echo Backing up the /home/rupxmn19/.rupayacore/rupaya.conf file to /root/rupaya19.conf
	cp /home/rupxmn19/.rupayacore/rupaya.conf ~/rupaya19.conf
	echo Backup complete
}
#
#MN20 - Backing up the rupaya.conf file
backup20(){
	echo Backing up the /home/rupxmn20/.rupayacore/rupaya.conf file to /root/rupaya20.conf
	cp /home/rupxmn20/.rupayacore/rupaya.conf ~/rupaya20.conf
	echo Backup complete
}	
#---------------------------------------------------------
#
...
restore17(){
	...
	cp rupaya17.conf /home/rupxmn17/.rupayacore/rupaya.conf
	chown rupxmn17:rupxmn17 /home/rupxmn17/.rupayacore/rupaya.conf
	echo Restore complete
}
#MN18 - Restoring the rupaya.conf file
restore18(){
	echo Restoring the /root/rupaya18.conf file to /home/rupxmn18/.rupayacore/rupaya.conf
	cp rupaya18.conf /home/rupxmn18/.rupayacore/rupaya.conf
	chown rupxmn18:rupxmn18 /home/rupxmn18/.rupayacore/rupaya.conf
	echo Restore complete
}
#MN19 - Restoring the rupaya.conf file
restore19(){
	echo Restoring the /root/rupaya19.conf file to /home/rupxmn19/.rupayacore/rupaya.conf
	cp rupaya19.conf /home/rupxmn/.rupayacore19/rupaya.conf
	chown rupxmn19:rupxmn19 /home/rupxmn19/.rupayacore/rupaya.conf
	echo Restore complete
}
#MN20 - Restoring the rupaya.conf file
restore20(){
	echo Restoring the /root/rupaya20.conf file to /home/rupxmn20/.rupayacore/rupaya.conf
	cp rupaya20.conf /home/rupxmn20/.rupayacore/rupaya.conf
	chown rupxmn20:rupxmn20 /home/rupxmn20/.rupayacore/rupaya.conf
	echo Restore complete
}
#---------------------------------------------------------
#
...
edit17(){
	nano /home/rupxmn17/.rupayacore/rupaya.conf
}
rm17conf(){
	rm /home/rupxmn17/.rupayacore/rupaya.conf
}
rm17core(){
	rm -r /home/rupxmn17/.rupayacore/
}
#
...
edit18(){
	nano /home/rupxmn18/.rupayacore/rupaya.conf
}
rm18conf(){
	rm /home/rupxmn18/.rupayacore/rupaya.conf
}
rm18core(){
	rm -r /home/rupxmn18/.rupayacore/
}
#
...
edit19(){
	nano /home/rupxmn19/.rupayacore/rupaya.conf
}
rm19conf(){
	rm /home/rupxmn19/.rupayacore/rupaya.conf
}
rm19core(){
	rm -r /home/rupxmn19/.rupayacore/
}
#
...
edit20(){
	nano /home/rupxmn20/.rupayacore/rupaya.conf
}
rm20conf(){
	rm /home/rupxmn20/.rupayacore/rupaya.conf
}
rm20core(){
	rm -r /home/rupxmn20/.rupayacore/
}
#
#---------------------------------------------------------
#
...
#Add 10 users, copy the SSH keys from root, and grant admin priveleges
add10users(){
        echo Adding 10 users named rupxmn-rupxmn10, copying the SSH keys from root, and granting admin priveleges
                useradd -m -s /bin/bash rupxmn && usermod -aG sudo rupxmn && mkdir /home/rupxmn/.ssh && cp /root/.ssh/authorized_keys /home/rupxmn/.ssh && chown -R rupxmn:rupxmn /home/rupxmn$i/.ssh && passwd rupxmn$i
        for i in {2..10}; do
                useradd -m -s /bin/bash rupxmn$i && usermod -aG sudo rupxmn$i && mkdir /home/rupxmn$i/.ssh && cp /root/.ssh/authorized_keys /home/rupxmn$i/.ssh && chown -R rupxmn$i:rupxmn$i /home/rupxmn$i/.ssh && passwd rupxmn$i
        done
}
#Add 20 users, copy the SSH keys from root, and grant admin priveleges
add20users(){
        echo Adding 20 users named rupxmn-rupxmn20, copying the SSH keys from root, and granting admin priveleges
                useradd -m -s /bin/bash rupxmn && usermod -aG sudo rupxmn && mkdir /home/rupxmn/.ssh && cp /root/.ssh/authorized_keys /home/rupxmn/.ssh && chown -R rupxmn:rupxmn /home/rupxmn$i/.ssh && passwd rupxmn$i
        for i in {2..20}; do
                useradd -m -s /bin/bash rupxmn$i && usermod -aG sudo rupxmn$i && mkdir /home/rupxmn$i/.ssh && cp /root/.ssh/authorized_keys /home/rupxmn$i/.ssh && chown -R rupxmn$i:rupxmn$i /home/rupxmn$i/.ssh && passwd rupxmn$i
        done
...
list(){
	...
	echo ${bold}add10users${normal} - Create 10 new users named ${bold}rupxmn-rupxmn10${normal}
	echo ${bold}add20users${normal} - Create 20 new users named ${bold}rupxmn-rupxmn20${normal}
	echo ""
}
#End of file
