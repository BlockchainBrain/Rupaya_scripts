...
# This script will download the files named vars.bash and profile-scripts-root-rupxmn-20MNs.profile 
...
echo "Downloading the file named profile-scripts-root-rupxmn-20MNs.profile and overwriting the /root/.profile"
wget https://raw.githubusercontent.com/BlockchainBrain/Rupaya_scripts/master/profile-scripts-root-rupxmn-20MNs.profile
wait
sudo rm /root/.profile
sudo mv profile-scripts-root-rupxmn-20MNs.profile /root/.profile
echo ""
