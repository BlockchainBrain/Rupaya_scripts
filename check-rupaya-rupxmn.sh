...
echo " The line you must edit is the first one after the group of lines starting with "
echo ""
echo ""
echo " You must also grant execution permission to this script with the command "chmod +x check-rupaya.sh""
echo ""
echo ""
echo ""
echo ""
