...
echo ""
echo " Rupaya daemon check and restart script - rupxmn users:"
...
echo ""
echo " A big thank you to @Respio for creating the script and sharing it with the community."
echo ""
echo " VERY IMPORTANT:"
...
echo " chmod +x check-rupaya-rupxmn.sh"
echo ""
