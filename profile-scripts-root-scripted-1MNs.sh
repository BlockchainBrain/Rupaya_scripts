...
# This script will download the files named vars.bash and profile-scripts-root-scripted-1MN.profile 
...
echo "Downloading the file named profile-scripts-root-scripted-1MN.profile and overwriting the /root/.profile"
wget https://raw.githubusercontent.com/BlockchainBrain/Rupaya_scripts/master/profile-scripts-root-scripted-1MN.profile
wait
sudo rm /root/.profile
sudo mv profile-scripts-root-scripted-1MN.profile /root/.profile
echo ""
